...
const KNOWN_DEMO_USERS = [
  ...
  { email: "zach@ops-demo.local", name: "Zach", label: "Supervisor Shift Leader" },
  { email: "sean@ops-demo.local", name: "Sean", label: "Supervisor Shift Leader" },
  { email: "rachel@ops-demo.local", name: "Rachel", label: "Supervisor Shift Leader" },
  { email: "tom@ops-demo.local", name: "Tom", label: "Supervisor Shift Leader" },
  { email: "erez@ops-demo.local", name: "Erez", label: "Supervisor Shift Leader" },
  { email: "talia@ops-demo.local", name: "Talia", label: "Supervisor Shift Leader" },
  { email: "oren@ops-demo.local", name: "Oren", label: "Supervisor Shift Leader" },
  { email: "aviad@ops-demo.local", name: "Aviad", label: "Supervisor Shift Leader" },
  { email: "igor@ops-demo.local", name: "Igor", label: "Supervisor" },
  { email: "noam@ops-demo.local", name: "Noam", label: "Supervisor" },
  { email: "ron@ops-demo.local", name: "Ron", label: "Supervisor" },
  { email: "noam-a@ops-demo.local", name: "Noam A", label: "Supervisor" },
  { email: "bashar@ops-demo.local", name: "Bashar", label: "Supervisor" },
  { email: "george@ops-demo.local", name: "George", label: "Supervisor" },
  { email: "omer@ops-demo.local", name: "Omer", label: "Supervisor" },
  { email: "noam-bs@ops-demo.local", name: "Noam BS", label: "Supervisor" },
  { email: "rivka@ops-demo.local", name: "Rivka", label: "Supervisor" },
  { email: "elodie@ops-demo.local", name: "Elodie", label: "Supervisor" },
  { email: "millie@ops-demo.local", name: "Millie", label: "Supervisor" },
  { email: "roi@ops-demo.local", name: "Roi", label: "Supervisor" },
  { email: "bashar-m@ops-demo.local", name: "Bashar M", label: "Supervisor" },
  { email: "tomer@ops-demo.local", name: "Tomer", label: "Supervisor" },
  { email: "eyal@ops-demo.local", name: "Eyal", label: "Supervisor" },
  { email: "cosmin@ops-demo.local", name: "Cosmin", label: "Supervisor" },
  { email: "sinai@ops-demo.local", name: "Sinai", label: "Supervisor" },
  { email: "tal@ops-demo.local", name: "Tal", label: "Supervisor" },
  { email: "chen@ops-demo.local", name: "Chen", label: "Supervisor" },
  { email: "roni@ops-demo.local", name: "Roni", label: "Supervisor" },
  { email: "lior@ops-demo.local", name: "Lior", label: "Supervisor" },
  { email: "yaron@ops-demo.local", name: "Yaron", label: "Supervisor" },
  { email: "kristina@ops-demo.local", name: "Kristina", label: "Supervisor" },
