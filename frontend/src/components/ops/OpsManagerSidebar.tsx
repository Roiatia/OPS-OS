...
export type OpsSection = "hub" | "maps" | "team" | "history" | "company-dashboard" | "settings";
...
interface Props {
  ...
  onSectionChange: (section: OpsSection) => void;
  fieldCount?: number;
  readyCount?: number;
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.id === "maps" && readyCount === 0 && fieldCount > 0 && (
                <span
                  className={`ml-auto text-[10px] font-bold tabular-nums px-1.5 py-0.5 rounded-full ${
